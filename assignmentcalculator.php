...
<head>
    ...
    <style>
        ...
        input[type="submit"] {
            background-color:rgb(187, 164, 14);
            color: white;
            padding: 10px;
            border: none;
            border-radius: 8px;
        ...
        input[type="submit"]:hover {
            background-color:rgb(213, 176, 11);
        }
        ...
        .result {
            ...
            border-left: 4px solid rgb(213, 176, 11);
            font-size: 18px;
            color: #333;
            border-radius: 8px;
        }
...
<body>
    ...
    <div class="calculator">
        ...
        ?>
                ...
                <?php
                 // Start session to track history
